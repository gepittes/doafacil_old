...
export const mutations = {
    ...
    [types.DELETE_PLATAFORMA](state, plataforma_id) {
        const index = state.plataforma.findIndex(plataforma => plataforma.plataforma_id === plataforma_id);
        state.plataforma.splice(index, 1);
    },
    [types.ATUALIZAR_PLATAFORMA](state, plataforma_editada) {
        const index = state.plataforma.findIndex(plataforma => plataforma.plataforma_id === plataforma_editada.plataforma_id);
