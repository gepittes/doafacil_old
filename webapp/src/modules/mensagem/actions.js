...
export const cadastrarMensagem = ({ commit }, mensagem) => axios.post('http://localhost/v1/mensagem', mensagem)
  .then((response) => {
    const data = response.data;
...
export const atualizarMensagem = ({ commit }, mensagem) => axios.patch(`http://localhost/v1/mensagem/${mensagem.mensagem_id}`, mensagem)
  .then(() => {
