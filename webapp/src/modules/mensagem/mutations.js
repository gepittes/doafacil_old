...
export const mutations = {
    ...
    [types.REMOVER_MENSAGEM](state, mensagem_id) {
        const index = state.mensagens.findIndex(mensagem => mensagem.mensagem_id === mensagem_id);
        state.mensagens.splice(index, 1);
    },
    [types.ATUALIZAR_MENSAGEM](state, mensagem_editada) {
        const index = state.mensagens.findIndex(mensagem => mensagem.mensagem_id === mensagem_editada.mensagem_id);
