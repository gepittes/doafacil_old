            ...
            <v-form ref="form" lazy-validation @submit.prevent="salvar()">
                ...
                <v-flex right>
                    ...
                    <v-text-field
                        ...
                        required
                    ></v-text-field>
                    <div v-if="submitted && errors.has('hora_open')" class="invalid-feedback">
                        {{ errors.first('hora_open') }}
                    </div>
                    <v-text-field
                        ...
                        :rules="[rules.required]"
                    ></v-text-field>
                    <div v-if="submitted && errors.has('hora_close')" class="invalid-feedback">
                        {{ errors.first('hora_close') }}
                    </div>
                </v-flex>
