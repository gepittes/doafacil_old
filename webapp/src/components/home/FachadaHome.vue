                  ...
                  <v-col xl="10" md="8" lg="10">
                    <v-card-text class="white--text">
                      <p class="t-justify body-2 font-italic">
                        ...
                        façam parte, as mudanças ressaltam a crescente
                        importância que todas elas assumem para a sociedade
                        contemporânea e, consequentemente, para os homens que a
                        constituem. (COLAUTO, BEUREN; 2003).
